...
public class FormQuanLyLinhKien extends JFrame implements ActionListener, MouseListener{
	...
	private JComboBox<String> jcbTimKiem;
	private Box a2;
	...
	public FormQuanLyLinhKien() {
		...
		b.add(Box.createVerticalStrut(10));
		String loaiTimKiem[] = {"Tìm Theo Mã LK","Tìm Theo Tên LK","Tìm Theo Mã loại LK","Tìm Theo Mã NCC"};
		jcbTimKiem = new JComboBox<String>(loaiTimKiem);
		b7.add(a2 =new Box(BoxLayout.X_AXIS),BorderLayout.WEST);
	...
	public static void main(String[] args) {
		new FormQuanLyLinhKien().setVisible(true);
	}
